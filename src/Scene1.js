...
class Scene1 extends Phaser.Scene {
    ...
    preload() {
        // this.load.image('deadPlayer', '/images/redblob.png')
        ...
        this.physics.add.collider(player.sprite, enemy.sprite, function () {
            ...
            if (player.healthBar.value === 0){
                ...
                // setTimeout(() => {
                    ...
                    // this.scene.start('Scene1'))
                //   }, 3100);
                //this.scene.pause()//will not allow me to use buttons
                //also at this point in time it would be ok for the player to go back to the main menu
                //and continue from his last save point. so i keep the main menu button but try to 
                //use set timout to destroy current text and replace with a restart button
            }
        }, null, this);
